...
async function getImi(req : RouterRequest, res : RouterResponse){
...
async function postImi(req : RouterRequest, res : RouterResponse){
    await db_connection(req, res, async(db) => {
...
async function setImi(req : RouterRequest, res : RouterResponse){
    await db_connection(req, res, async(db) => {
...
async function deleteImi(req : RouterRequest, res : RouterResponse){
    await db_connection(req, res, async(db) => {
