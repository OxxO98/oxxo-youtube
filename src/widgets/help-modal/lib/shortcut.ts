...
export const getShortcutMap = (t : Translate) : ShortcutConfig[] => [
    ...
    { id : 'mark-start', keyCombos : [['a']], groups : ['marking'], label : getShortcutLabel(t, 'MARK_START') },
    { id : 'select-start', keyCombos : [['s']], groups : ['marking'], label : getShortcutLabel(t, 'SELECT_START') },
    { id : 'select-end', keyCombos : [['d']], groups : ['marking'], label : getShortcutLabel(t, 'SELECT_END') },
    { id : 'mark-end', keyCombos : [['f']], groups : ['marking'], label : getShortcutLabel(t, 'MARK_END') },
