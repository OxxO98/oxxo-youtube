...
- nodejs-whisper 라이브러리를 통해 인식한 음성으로 초안을 작성 할 수 있습니다.

- 해당 유튜브 영상에 자막이 지원되는 경우에는 자막 정보를 가져와서 작성 할 수 있습니다.

- 자막과 음성인식 결과를 비교해서 볼 수 있습니다. 해당 데이터를 클릭해 그 부분을 재생할 수 있습니다.

- OPENAI_API_KEY가 환경변수에 등록된 경우 openAI의 `whisper`모델을 통해 음성을 인식합니다.

- 만약, 해당 영상의 대본 정보가 있는 경우에는 텍스트를 입력해, 음성인식 결과를 보정할 수 있습니다.
...
- 현재 영상에 등록한 단어가 없는 경우 MECAB라이브러리를 통해 자동으로 단어를 등록 할 수 있습니다.
